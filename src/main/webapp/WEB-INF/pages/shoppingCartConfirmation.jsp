...
<div class="customer-info-container">
    ...
    <ul>
        ...
        <li>Total:
            <span class="total">
                <fmt:formatNumber value="${myCart.amountTotal}" type="currency" currencyCode="BYN"/>
          </span></li>
    </ul>
</div>
        ...
        <div class="product-preview-container">
            <ul>
                ...
                <li>Price: <span class="price">
                    <fmt:formatNumber value="${cartLineInfo.productInfo.price}" type="currency" currencyCode="BYN"/>
                </span>
                </li>
                <li>Quantity: ${cartLineInfo.quantity}</li>
                <li>Subtotal:
                    <span class="subtotal">
                        <fmt:formatNumber value="${cartLineInfo.amount}" type="currency" currencyCode="BYN"/>
                    </span>
                </li>
            </ul>
        </div>
